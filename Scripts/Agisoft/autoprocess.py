...
def photoscanProcess(root_path):
    ...
    ## save project
    ##doc.save("M:/Photoscan/practise.psx")
    chunk = doc.addChunk()
    ...
    try:
        doc.save(psxfile)
        PhotoScan.app.messageBox("Save project file successfully!")
    except Exception as e:
        print(doc, "doc")
        PhotoScan.app.messageBox("Save project file failed!")
    ...
    chunk.matchPhotos(
        accuracy=PhotoScan.LowAccuracy,
    ...
    chunk.buildDenseCloud(
        quality=PhotoScan.LowQuality, filter=PhotoScan.AggressiveFiltering
    )
